...
//experimental
void cudnn_mem_copy_gpu2(int batch, int channels, int size, int padding_x, int padding_y, int stride, float *premat_ptr, float *in_ptr, float* out_ptr, int * ptr_location, int p_size, int in_p_height, int in_p_width, int k_size_x, int k_size_y, int patch_growing);
