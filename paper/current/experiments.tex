...
\vspace{2mm}
\noindent \textbf{Memory Overhead.} \red{We compare our batched incremental inference against full re-inference on GPU. Our approach actually \textit{reduces} memory footprint by 58\%. Due to space constraints, we explain this result further in Appendix~\ref{sec:mem_overhead}.}
