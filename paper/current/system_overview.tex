...
In this section we formalize the internals of some of the layers in a Deep CNN which will be later used to propose our incremental inference approach in Section 4. We then formally state the problem, explain our assumptions, and give an overview of~\system.
