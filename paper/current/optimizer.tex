...
\red{It is also important to note that there exists several other methods such as low-precision computation \cite{moons20160} and CNN model pruning \cite{he2017channel} which enable faster approximate CNN inference. Our optimizations are complementary to these existing approaches and can be applied together.}
